...
3) Access the `workbench` named `audio-to-text-p1743667578371-notebook`.
...
5) In the terminal, run `cd audio-to-text-p1743667578371` to navigate to your sample app's directory.
